...
def setup():
    ...
    <div class="col-md-6 offset-md-3">
        ...
        <h3 class="text-center">
            <p>A cool CTF platform from <a href="https://w4rf0t.github.io">w4rf0t</a></p>
            <p>Follow us on social media:</p>
            <a href="https://facebook.com/w4rf0t"><i class="fab fa-facebook fa-2x" aria-hidden="true"></i></a>&nbsp;
            <a href="https://github.com/w4rf0t"><i class="fab fa-github fa-2x" aria-hidden="true"></i></a>
        </h3>
        <br>
